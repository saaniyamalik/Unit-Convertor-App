...
def set_bg_image(image_url):
    ...
    <style>
    .stApp {{
        background: url("https://images.pexels.com/photos/311039/pexels-photo-311039.jpeg?auto=compress&cs=tinysrgb&w=600") no-repeat center center fixed;
...
set_bg_image("https://source.unsplash.com/1600x900/?technology,nature")
